...
parameters = AdamModel(X_Train, Y_Train, lay_size, lay_adam, learning_rate=1.0, minibatch_size=64, beta1=0.9, beta2=0.999, epsilon=1e-8, n_epoch=1000, print_cost=True)
